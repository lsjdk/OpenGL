...
void Texture :: modulChangeSize(int w,int h) {
...
void Texture :: modulSpecialKeys(int key, int x, int y) {
    if (key == GLUT_KEY_UP) {
...
void Texture :: modulKeyPressFunc(unsigned char key, int x, int y) {
    
}
void Texture :: modulProcessMenu(int value) {
    
}


void Texture :: modulShutdownRC() {
